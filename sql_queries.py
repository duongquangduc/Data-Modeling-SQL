...
2. Write DROP statements in sql_queries to drop each table if exists
"""

# DROP TABLES
# There are five tables in total
...
LEFT OUTER JOIN artist AS a ON s.artist_id = a.artist_id
WHERE s.title = %s AND a.name = %s AND s.duration = %s;
""")

# QUERY LISTS
create_table_queries = [song_table_create, user_table_create, song_table_create, artist_table_create, time_table_create]
